...
main:
  ...
  #########Ejercicio3 pruebas con CICLOS DE PENALIZACION NOP de CORRECTO FUNCIONAMIENTO (Carlos y Adrian)#############
  nop
  nop
  nop
  nop
  ...
  lw $t4, 0($t5)	  #r12 = 16
  nop
  and $t6, $t3, $t5	  #r14 =10 and 16 = 0 
  and $t1, $t4, $t2	  #r9 = 16 and 2 = 0 
  nop
  nop
  or $t4, $t3, $t1	  #r12 = 10 or 0 = 10
  nop
  nop
  sw $t4, 4($t5)	  #data[20]= 16
  lw $t2, 4($t5)	  #t2 = data[20]=16	
